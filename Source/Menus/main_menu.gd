...
@onready var exit_hovered = false
...
func _physics_process(delta: float) -> void:
	...
	if exit_hovered:
		var hover_tween5 = create_tween()
		hover_tween5.tween_property(%Exit, "global_position:y", button_yh, 0.2)
	else:
		var hover_tween5 = create_tween()
		hover_tween5.tween_property(%Credits, "global_position:y", button_y, 0.2)
